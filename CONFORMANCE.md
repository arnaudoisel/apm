# OpenAPM Conformance Binding Inventory -- v0.2.0
...
This inventory assesses only the selected corrective revision. It does not establish historical CLI conformance to the previous minor's req-mf-016 blanket project-root refusal. A prepared specification and collected bindings do not establish publication or ratification.
...
| [req-mf-016](docs/src/content/docs/specs/openapm-v0.2.md#req-mf-016) | MUST | 4.3.5 | consumer | active | 36 | - |
...
| [req-rs-011](docs/src/content/docs/specs/openapm-v0.2.md#req-rs-011) | MUST | 7.7 | consumer | active | 1 | - |
